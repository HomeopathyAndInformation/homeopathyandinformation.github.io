...
const appt = document.getElementsByClassName("viewmeet")[0];
...
for(let i=0; i < links.length; i++){
    links[i].addEventListener("click", ()=> {
        ...
        appt.getElementsByTagName("h2")[1].textContent = data[attr].appt.form;
        appt.getElementsByTagName("h2")[2].textContent = data[attr].appt.notes;
