...
for(let i=0; i < links.length; i++){
    links[i].addEventListener("click", ()=> {
        ...
        appt.getElementsByTagName("p")[0].textContent = data[attr].appt.type;
        appt.getElementsByTagName("p")[1].textContent = data[attr].appt.link;
        appt.getElementsByTagName("p")[2].textContent = data[attr].appt.date;
        appt.getElementsByTagName("p")[3].textContent = data[attr].appt.resq;
        appt.getElementsByTagName("p")[4].textContent = data[attr].appt.cans;
        if(appt.getElementsByClassName("noappt")[0]){
            appt.getElementsByClassName("noappt")[0].textContent = data[attr].appt.noappt;
        }
...
var data = {
    "english":{
        ...
        "appt":{
            ...
            "noappt":"You do not have any scheduled appointments.",
        },
    ...
    "arabic":{
        ...
        "appt":{
            ...
            "resq": "إعادة الجدولة",
            "cans": "إلغاء",
            "noappt":"ليس لديك أي مواعيد مجدولة.",
        },
    ...
    "french":{
        ...
        "appt":{
            ...
            "resq":"Replanifier",
            "cans":"Annulation",
            "noappt":"Vous n'avez pas de rendez-vous programmés.",
        },
