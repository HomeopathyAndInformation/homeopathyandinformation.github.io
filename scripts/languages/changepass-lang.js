...
for(let i=0; i < links.length; i++){
    links[i].addEventListener("click", ()=> {
        ...
        login.getElementsByTagName("label")[0].textContent = data[attr].login.pass;
        login.getElementsByTagName("label")[1].textContent = data[attr].login.rpass;
...
var data = {
    ...
    "arabic":{
        ...
        "login":{
            "title":"غير كلمة السر",
            "pass":"كلمة السر الجديدة",
            "rpass":"كرر كلمة المرور الجديدة",
            "button":"غير كلمة السر",
        },
    ...
    "french":{
        ...
        "login":{
            ...
            "rpass":"Répété le nouveau mot de passe",
