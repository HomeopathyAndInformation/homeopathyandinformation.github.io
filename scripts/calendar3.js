...
for(let i = 0; i < daysInCal.length; i++){
    ...
    daysInCal[i].addEventListener("click", (e)=>{
        ...
        for(let j = 0; j < events.length; j++){
            ...
            //let newDate = new Date(Date.UTC(dateSplit[0],dateSplit[1]-1,dateSplit[2],timeSplit[0],timeSplit[1].split(" ")[0],0o0));
            ...
            let localDate = "";
            if(parseInt(eventTime.split(":")[0]) > 11){
                if(eventTime.split(":")[0] == 12){
                    localDate = eventTime.split(":")[0] + ":" + eventTime.split(":")[1] + " PM";
                } else {
                    localDate = (parseInt(eventTime.split(":")[0]) - 12).toString() + ":" + eventTime.split(":")[1] + " PM";
                }
            }else{
                localDate = eventTime.split(":")[0] + ":" + eventTime.split(":")[1] + " AM";
            }
                    ...
                    if((parseInt(LocalDay) < parseInt(dateSplit[2]) || parseInt(LocalMonth) < parseInt(currentMonth))){
                        ...
                        dayPrev.addEventListener("click", (e)=>{
                            ...
                            for(let h = 0; h < Nevents.length; h++){
                                ...
                                //Set as UTC programmically
                                let NnewDate = new Date(Date.UTC(NdateSplit[0],NdateSplit[1]-1,NdateSplit[2],NtimeSplit[0],NtimeSplit[1].split(" ")[0],0o0));
